...
const data = [
  {
    id: 1,
    avatar:
      "https://raw.githubusercontent.com/cigulatte/movieApp-Redux/main/src/screenshots/homegrid.png",
    name: "HomeGrid",
    designation: "",
    socialLinks: [],
  },
  {
    id: 2,
    avatar:
      "https://raw.githubusercontent.com/cigulatte/movieApp-Redux/main/src/screenshots/homelist.png",
    name: "HomeList",
    designation: "",
    socialLinks: [],
  },
  {
    id: 3,
    avatar:
      "https://raw.githubusercontent.com/cigulatte/movieApp-Redux/main/src/screenshots/detail.png",
    name: "Detail",
    designation: "",
    socialLinks: [],
  },
  {
    id: 4,
    avatar:
      "https://raw.githubusercontent.com/cigulatte/movieApp-Redux/main/src/screenshots/moviesearch.png",
    name: "Search",
    designation: "",
    socialLinks: [],
  },
  ...
  return (
    <Box as="section" id="projects" sx={styles.section}>
      <Container ref={containerRef}>
        <SectionHeading
          ui={"https://github.com/cigulatte/movieApp-Redux"}
          sx={styles.heading}
          title="Movie App"
          description=""
          icon={true}
