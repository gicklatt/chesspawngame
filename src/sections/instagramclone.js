...
const data = [
  {
    id: 1,
    avatar:
      "https://raw.githubusercontent.com/cigulatte/instagramui/main/src/screenshots/home.png",
    name: "Home",
    designation: "",
    socialLinks: [],
  },
  {
    id: 2,
    avatar:
      "https://raw.githubusercontent.com/cigulatte/instagramui/main/src/screenshots/home2.png",
    name: "Like animation",
    designation: "",
    socialLinks: [],
  },
  {
    id: 3,
    avatar:
      "https://raw.githubusercontent.com/cigulatte/instagramui/main/src/screenshots/postdetail.png",
    name: "Post detail",
    designation: "",
    socialLinks: [],
  },
  {
    id: 4,
    avatar:
      "https://raw.githubusercontent.com/cigulatte/instagramui/main/src/screenshots/search.png",
    name: "Search",
    designation: "",
    socialLinks: [],
  },
  {
    id: 5,
    avatar:
      "https://raw.githubusercontent.com/cigulatte/instagramui/main/src/screenshots/shopping.png",
    name: "Shopping",
    designation: "",
    socialLinks: [],
  },
  ...
  return (
    <Box as="section" id="projects" sx={styles.section}>
      <Container ref={containerRef}>
        <SectionHeading
          ui={"https://github.com/cigulatte/instagramui"}
          sx={styles.heading}
          title="Instagram-UI"
          description=""
          icon={true}
